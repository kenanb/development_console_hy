...
# original code from 'console_python.py'
...
def get_console(console_id):
    ...
    if console_data:
        ...
        #Uses hy.cmdline.HyREPL instead of code.InteractiveConsole.
        console = hy.cmdline.HyREPL(locals=namespace,
                                    filename="<blender_console>")

        #Uses Hy syntax instead of Python in the code to push into console.
        console.push("(import [mathutils [*]])")
        console.push("(import [math [*]])")
...
def banner(context):
    ...
    add_scrollback("HY INTERACTIVE CONSOLE %s" % version_string, 'OUTPUT')
